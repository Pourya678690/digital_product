# Generated by Django 4.2 on 2025-03-08 18:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decription', models.TextField(blank=True, verbose_name='description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=30, verbose_name='Name')),
                ('decription', models.TextField(blank=True, verbose_name='description')),
                ('avatar', models.ImageField(blank=True, upload_to='files/%Y/%m/%d/', verbose_name='avatar')),
                ('is_enable', models.BooleanField(default=True, verbose_name='is_enable')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='created_time')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='updated_time')),
